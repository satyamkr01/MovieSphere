...
import com.unifydream.moviesphere.ui.viewmodel.HomeViewModel
import com.unifydream.moviesphere.graph.MovieAppScreen
import com.unifydream.moviesphere.graph.RootNavigation
import com.unifydream.moviesphere.data.models.Genre
import com.unifydream.moviesphere.data.models.Movies
import com.unifydream.moviesphere.ui.view.screens.components.ErrorStrip
import com.unifydream.moviesphere.ui.view.screens.components.HomeGenre
import com.unifydream.moviesphere.ui.view.screens.components.HomeHeader
import com.unifydream.moviesphere.ui.view.screens.components.HomeSmallThumb
import com.unifydream.moviesphere.ui.view.screens.components.HomeThumbRectWithTitle
import com.unifydream.moviesphere.ui.view.screens.components.HomeThumbWithTitle
import com.unifydream.moviesphere.ui.view.screens.components.NoInternetScreen
import com.unifydream.moviesphere.ui.theme.MovieSphereTheme
import com.unifydream.moviesphere.utlis.AutoSlidingCarousel
import com.unifydream.moviesphere.utlis.CenteredCircularProgressIndicator
import com.unifydream.moviesphere.utlis.Constants
...
import com.unifydream.moviesphere.utlis.IncludeApp
import com.unifydream.moviesphere.utlis.MovieState
import com.unifydream.moviesphere.utlis.ShowError
import com.unifydream.moviesphere.utlis.SimpleLightTopAppBar
import com.unifydream.moviesphere.utlis.Tools
...
fun HomeScreen(viewModel: HomeViewModel = hiltViewModel(), navController: NavHostController) {
    ...
    Column(
        ...
        when (nowPlayingMovieState) {
            is MovieState.Success -> {
                val movies = (nowPlayingMovieState as MovieState.Success<MovieResponse?>).data?.results.orEmpty()
                HomeHeader("Now Playing", {
